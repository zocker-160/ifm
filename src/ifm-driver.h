...
extern char *room_exit_colour, *page_size;
...
extern float map_text_fontsize, title_fontsize, font_scale, page_margin;
...
extern int show_title, show_tags, link_spline, map_border_size;
