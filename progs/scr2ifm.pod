...
This Info file describes version 1.0 of scr2ifm, a program for creating
maps in Ifm (*note Ifm:(ifm).) format from one or more files containing
game transcripts.
...
=for inf node HINTS AND TIPS, Hints and Tips, How to improve things
...
=for inf node RESTRICTIONS, Restrictions, Limitations of scr2ifm
