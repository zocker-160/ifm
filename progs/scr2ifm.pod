...
connection in.  However, you can override its choice.
...
Here's a simple example of B<scr2ifm> in action.  You might recognize the
IF game involved.  First, the transcript in file F<advent.scr> (with
annotation):
...
Goodness me!  That was unexpected -- you've been teleported.  The link
almost certainly won't look good on the map.  You have the option of
