...
=for inf node Example Map,, Sample map to be drawn
...
=for inf node Output Variables,, Customizing output

=for inf node OUTPUT VARIABLES, Output Variables, Variables used by output formats
=for inf node Room Variables,, Setting the appearance of rooms
=for inf node Link Variables,, Setting the appearance of links
=for inf node Feature Variables,, Enabling optional features
=for inf node PostScript Page Variables,, Controlling PostScript pages
=for inf node Tk Window Variables,, Setting Tk window attributes
=for inf node Miscellaneous Variables,, Other useful variables

=for inf node LANGUAGE, Language, Language specification
=for inf node Format,, General layout of the input
=for inf node Control,, Map sections and local variables
=for inf node Tags,, Format of tags
=for inf node Commands,, Format of commands
...
=for inf node Variables,, Format of variables
