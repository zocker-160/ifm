...
On startup, B<IFM> does the following.  Firstly, the initialization file is
read.  This sets defaults used by everyone.  This file is called
...
The arguments to the B<-show> option can be:
