...
The :samp:`-o` option sets the file template for the output files. It must
...
change. You can use the :samp:`-L` option of :program:`fig2dev` to set the
output format. See the :program:`fig2dev` manpage for details.
