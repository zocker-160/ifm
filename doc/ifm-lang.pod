...
the following syntax:
    ...
    [FORMAT] IDENT = NUMBER | STRING | undef [in style STRING];
...
(if any) becomes the current style.  The string, if specified, should match
the name in the corresponding 'style' command, or a warning is given.
