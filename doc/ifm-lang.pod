...
the following syntax:
    ...
    [FORMAT] IDENT = NUMBER | STRING | undef;
...
zero.  A special case is when the expression consists of a single variable
reference -- then the variable value is copied exactly.  For example:

    name = "foo";	# Variable "name" has value "foo"
    name2 = $name;	# Variable "name2" now also has value "foo"
    name3 = $name + 1;	# Variable "name3" has value 1
